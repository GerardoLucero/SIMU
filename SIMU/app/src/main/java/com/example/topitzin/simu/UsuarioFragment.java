...
public class UsuarioFragment extends Fragment {
    ...
    private void eventos(final View view) {
        ...
        modificar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                crearAlerta(view, "¿Desea modificar este usuario?", 1);
                alert.show();
            }
        });
        ...
        eliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                crearAlerta(view, "¿Desea eliminar este usuario?", 2);
                alert.show();
            }
        });
    ...
    private void buscarObjetos(View view) {
        ...
        atras = (FloatingActionButton) view.findViewById(R.id.back);
        modificar = (FloatingActionButton) view.findViewById(R.id.modificar);
        eliminar = (FloatingActionButton) view.findViewById(R.id.eliminar);
